...
// loop over the bills array, then fill both the tips, totals arrays
...
// this function will loop over the array which pass here, then sum each item, finally divide the total sum of all these values in the length of the array
...
console.log(calcAverage(totals)); // average of totals
console.log(calcAverage(tips)); // average of tips
